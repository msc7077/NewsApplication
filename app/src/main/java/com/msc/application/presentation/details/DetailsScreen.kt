...
import com.msc.application.domain.model.Source
import com.msc.application.presentation.Dimens.ArticleImageHeight
import com.msc.application.presentation.Dimens.MediumPadding1
import com.msc.application.presentation.details.components.DetailsTopBar
...
fun DetailsScreen(
    ...
    Column(
        ...
        DetailsTopBar(
            ...
            onBookMarkClick = {
                event(DetailsEvent.UpsertDetailArticle(article))
            },
